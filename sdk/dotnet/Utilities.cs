...
namespace PhoenixNAP.Pulumi.Pnap
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/phoenixnap/pulumi-pnap/releases/";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("PhoenixNAP.Pulumi.Pnap.version.txt");
    ...
    internal sealed class PnapResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PnapResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
