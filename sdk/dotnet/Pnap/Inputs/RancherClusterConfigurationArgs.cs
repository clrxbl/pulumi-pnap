...
namespace PhoenixNAP.Pulumi.Pnap.Inputs
{
    ...
    public sealed class RancherClusterConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Define the custom SSL certificates to be used instead of defaults. The `certificates` block has 3 fields.
        /// </summary>
        [Input("certificates")]
        public Input<Inputs.RancherClusterConfigurationCertificatesArgs>? Certificates { get; set; }
        ...
        public RancherClusterConfigurationArgs()
        {
        }
        public static new RancherClusterConfigurationArgs Empty => new RancherClusterConfigurationArgs();
    }
}
