...
namespace PhoenixNAP.Pulumi.Pnap.Inputs
{
    ...
    public sealed class RancherClusterNodePoolsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("nodes")]
        private InputList<Inputs.RancherClusterNodePoolsNodeGetArgs>? _nodes;

        /// <summary>
        /// The nodes associated with this node pool.
        /// </summary>
        public InputList<Inputs.RancherClusterNodePoolsNodeGetArgs> Nodes
        {
            get => _nodes ?? (_nodes = new InputList<Inputs.RancherClusterNodePoolsNodeGetArgs>());
            set => _nodes = value;
        }
        ...
        /// </summary>
        [Input("sshConfig")]
        public Input<Inputs.RancherClusterNodePoolsSshConfigGetArgs>? SshConfig { get; set; }

        public RancherClusterNodePoolsGetArgs()
        {
        }
        public static new RancherClusterNodePoolsGetArgs Empty => new RancherClusterNodePoolsGetArgs();
    }
}
