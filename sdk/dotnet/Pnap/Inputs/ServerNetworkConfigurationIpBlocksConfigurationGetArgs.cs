...
namespace PhoenixNAP.Pulumi.Pnap.Inputs
{
    ...
    public sealed class ServerNetworkConfigurationIpBlocksConfigurationGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("ipBlocks")]
        private InputList<Inputs.ServerNetworkConfigurationIpBlocksConfigurationIpBlockGetArgs>? _ipBlocks;
        ...
        /// </summary>
        public InputList<Inputs.ServerNetworkConfigurationIpBlocksConfigurationIpBlockGetArgs> IpBlocks
        {
            get => _ipBlocks ?? (_ipBlocks = new InputList<Inputs.ServerNetworkConfigurationIpBlocksConfigurationIpBlockGetArgs>());
            set => _ipBlocks = value;
        }

        public ServerNetworkConfigurationIpBlocksConfigurationGetArgs()
        {
        }
        public static new ServerNetworkConfigurationIpBlocksConfigurationGetArgs Empty => new ServerNetworkConfigurationIpBlocksConfigurationGetArgs();
    }
}
