...
type Provider struct {
	...
	ConfigFilePath pulumi.StringPtrOutput `pulumi:"configFilePath"`
}
...
func (o ProviderOutput) ConfigFilePath() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Provider) pulumi.StringPtrOutput { return v.ConfigFilePath }).(pulumi.StringPtrOutput)
}
