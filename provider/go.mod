...
require (
	github.com/phoenixnap/terraform-provider-pnap v0.24.0
...
require (
	...
	github.com/PNAP/go-sdk-helper-bmc v0.16.1 // indirect
	...
	github.com/phoenixnap/go-sdk-bmc/tagapi/v3 v3.0.1 // indirect
